...
class UtilisateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilisateur" do
    assert_difference('Utilisateur.count') do
      post utilisateurs_url, params: { utilisateur: { password: @utilisateur.password, pseudo: @utilisateur.pseudo } }
    end
  ...
  test "should update utilisateur" do
    patch utilisateur_url(@utilisateur), params: { utilisateur: { password: @utilisateur.password, pseudo: @utilisateur.pseudo } }
